...
class Count64_64 extends Count64Base {
  ...
  public function getHiBytes() {
    return PackBits::urShift($this->value, 32);
  }

  public function getLoBytes() {
    return $this->value & PackBits::INT64_LOW_MAP;
  }
  ...
  public function set($value) {
    if (is_int($value)) {
      if ($this->limit32Bit && PackBits::INT_MAX_32 < $value) {
  ...
  public function add($value) {
    ...
    if ($this->limit32Bit && PackBits::INT_MAX_32 < $sum) {
      throw new \OverFlowException(self::EXCEPTION_32BIT_OVERFLOW);
    }
    $this->value = $sum;
    return $this;
